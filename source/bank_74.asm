...
INCBIN "gfx/safari_map/lv_4_jungle_zone.bin"
.end::
gfx_lv_4_jungle_zone_sgb::
INCBIN "gfx/safari_map/lv_4_jungle_zone_sgb.bin"
.end::
...
INCBIN "gfx/safari_map/lv_4_jungle_zone_unused.bin"
.end::

gfx_lv_3_sea_cottage::
INCBIN "gfx/town_map/lv_3_sea_cottage.bin"
.end::
gfx_lv_3_sea_cottage_sgb::
INCBIN "gfx/town_map/lv_3_sea_cottage_sgb.bin"
.end::
; The unused "3" in "3/10" is has less of a black border.
gfx_lv_3_sea_cottage_duplicate::
INCBIN "gfx/town_map/lv_3_sea_cottage_unused.bin"
.end::
