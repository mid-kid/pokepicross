...
gfx_lv_4_s_s_anne::
INCBIN "gfx/town_map/lv_4_s_s_anne.bin"
.end::
gfx_lv_4_s_s_anne_sgb::
INCBIN "gfx/town_map/lv_4_s_s_anne_sgb.bin"
.end::
...
INCBIN "gfx/town_map/lv_5_pokemon_tower.bin"
.end::
gfx_lv_5_pokemon_tower_sgb::
INCBIN "gfx/town_map/lv_5_pokemon_tower_sgb.bin"
.end::
